...
const mockEvents = [
  {
    ...
    description:
      "Join us for our annual sports day celebration with fun activities for all children.",
    type: "sports",
    status: "upcoming",
  },
  {
    ...
    description:
      "Discuss your child's progress and development with their teacher.",
    type: "meeting",
    status: "upcoming",
  },
  {
  ...
  },
  {
    ...
    location: "City Park",
    description:
      "Fun-filled day out with games, food, and activities for families.",
    type: "outing",
    status: "upcoming",
  },
];
    ...
    try {
      ...
      if (!resp.ok || !json.success) {
        ...
        showCustomAlert(
          "error",
          "Request failed",
          json?.message || "Unable to submit complaint"
        );
        return;
      }
  ...
  const handleMeetingRequest = async () => {
    ...
    if (!childId) {
      showCustomAlert(
        "error",
        "No child selected",
        "Please select a child in your profile first."
      );
      return;
    }
    ...
    if (!meeting_time) {
      showCustomAlert(
        "error",
        "Invalid time",
        'Please enter time like "09:30 AM" or "14:30".'
      );
      return;
    }
    ...
    try {
      ...
      const resp = await fetch(`${API_BASE_URL}/parent/meetings/meeting`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          ...(token ? { Authorization: `Bearer ${token}` } : {}),
      ...
      if (!resp.ok || !json.success) {
        ...
        showCustomAlert(
          "error",
          "Request failed",
          json?.message || "Unable to send meeting request"
        );
        return;
      }
      ...
      showCustomAlert(
        "success",
        "Request Sent",
        `Meeting request sent to ${meetingForm.recipient}.`,
        false,
        closeMeetingModal
      );
    } catch (err) {
    ...
    >
              ...
              <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View className="mb-4">
                  ...
                  <View className="flex-row flex-wrap">
                    {["teacher", "supervisor"].map((role) => (
                      ...
                      >
                        <Text
                          className={`text-sm font-medium ${meetingForm.recipient === role ? "text-white" : "text-gray-700"}`}
                        >
                ...
                <View className="mb-4">
                  ...
                  <TextInput
                    ...
                    onChangeText={(value) =>
                      setMeetingForm((prev) => ({ ...prev, date: value }))
                    }
                ...
                <View className="mb-4">
                  ...
                  <TextInput
                    ...
                    onChangeText={(value) =>
                      setMeetingForm((prev) => ({ ...prev, time: value }))
                    }
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50"
                ...
                <View className="mb-6">
                  ...
                  <TextInput
                    ...
                    onChangeText={(value) =>
                      setMeetingForm((prev) => ({ ...prev, reason: value }))
                    }
                    multiline
                    numberOfLines={3}
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50"
              ...
              <ScrollView showsVerticalScrollIndicator={false}>
                <View className="mb-4">
                  ...
                  <TextInput
                    ...
                    onChangeText={(value) =>
                      setComplaintForm((prev) => ({ ...prev, subject: value }))
                    }
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50"
                  ...
                  >
                    <View className="flex-row items-center">
                      ...
                      <View className="items-center">
                        <View
                          className={`px-2 py-1 rounded-full mb-2 ${item.status === "upcoming" ? "bg-purple-100" : "bg-gray-100"}`}
                        >
                          <Text
                            className={`text-xs font-medium ${item.status === "upcoming" ? "text-purple-600" : "text-gray-600"}`}
                          >
                            {item.status}
                          </Text>
                        </View>
                  ...
                  <View className="space-y-4">
                    ...
                    <View className="flex-row items-center p-4 bg-gray-50 rounded-xl">
                      ...
                      <View className="ml-4">
                        ...
                        <Text
                          className={`text-base font-semibold ${selectedEvent.status === "upcoming" ? "text-green-600" : "text-gray-600"}`}
                        >
        ...
        >
          ...
          >
            ...
            <View className="mb-4">
              ...
              <Text className="text-base text-gray-700 mb-2 mt-4">
                Email Addresses
              </Text>
              <View>
                <Text className="text-lg font-semibold text-purple-700">
                  info@littlesteps.com
                </Text>
                <Text className="text-lg font-semibold text-purple-700">
            ...
            <Text className="text-sm text-gray-500">
              We are here to help you with any questions or concerns regarding
              your child&apos;s care and experience at our daycare centre.
            </Text>
          </View>
        </View>
      </Modal>
      ...
      >
        ...
        >
          ...
          <View
            className="rounded-t-3xl p-6"
            style={{ backgroundColor: "white", maxHeight: "70%" }}
          >
            <View className="flex-row items-center justify-between mb-6">
              <Text className="text-xl font-bold text-gray-800">
                Privacy Policy
            ...
            <ScrollView showsVerticalScrollIndicator={true}>
              <Text className="text-base text-gray-700 mb-4 font-semibold">
                Rules and Regulations
              </Text>
              <Text className="text-sm text-gray-700 mb-2">
                1. All personal information is kept confidential and is only
                used for daycare operations.
              </Text>
              <Text className="text-sm text-gray-700 mb-2">
                2. We do not share your data with third parties without your
                consent.
              </Text>
              <Text className="text-sm text-gray-700 mb-2">
                3. You have the right to access, update, or request deletion of
                your data at any time.
              </Text>
              <Text className="text-sm text-gray-700 mb-2">
                4. Our staff are trained to handle your information securely and
                responsibly.
              </Text>
              <Text className="text-sm text-gray-700 mb-2">
                5. For more details, please contact our support team.
              </Text>
            </ScrollView>
          </View>
        </View>
